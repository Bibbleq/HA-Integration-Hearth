...
| hassfest | green |
| HACS validation | advisory only while the repo is private (see D18); licence, topics-ignored and brand checks pass, manifest/hacs.json reads fail on a private repo |
